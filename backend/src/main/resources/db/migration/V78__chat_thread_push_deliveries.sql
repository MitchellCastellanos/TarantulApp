...
create table chat_thread_push_deliveries (
...
create index idx_chat_thread_push_deliveries_thread_sent
    on chat_thread_push_deliveries(thread_id, sent_at desc);

create index idx_chat_thread_push_deliveries_recipient
